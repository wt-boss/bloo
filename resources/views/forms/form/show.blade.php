...
<div class="container-detached">
	<div class="content-detached">
            ...
            <div class="panel panel-body submit hidden">
                ...
                <button type="submit" style="background-color: #0065a1;" class="btn btn-success btn-xs" id="submit" data-loading-text="{{ trans('Saving...') }}" data-complete-text="{{ trans('Save') }}">{{ trans('Save') }}</button>
