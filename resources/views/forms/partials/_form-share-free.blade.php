<button  style="background-color: #0065A1;" class="btn btn-xs btn-success dropdown-toggle" data-toggle="dropdown" style="margin-left: 10px;"><i class="fa fa-share-alt" aria-hidden="true"></i> {{ trans('share') }}</button>
