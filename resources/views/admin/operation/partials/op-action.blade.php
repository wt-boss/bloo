<button class="btn btn-xs btn-bloo-success dropdown-toggle" data-toggle="dropdown" style="margin-left: 10px;">{{ trans('actions') }} <span class="caret"></span></button>
<ul class="dropdown-menu dropdown-menu-right" style="padding: 10px;">
    ...
    <li><a href="{{route('lockoperation',$operation->id)}}" class="btn  btn-bloo-action mb-5">Cloturer Operation</a></li>
