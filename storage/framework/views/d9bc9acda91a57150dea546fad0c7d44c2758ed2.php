<?php $__env->startSection('content'); ?>
    <?php $__env->startSection('title', 'Sondage en ligne'); ?>
        ...
        <div class="container-fluid">
          <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
              <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo e(route('home')); ?>"> <?php echo e(trans('home_fil')); ?></a></span> <span><?php echo e(trans('sondage_fil')); ?></span></p>
              <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo e(trans('sondage_fil')); ?></h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="ftco-section bg-light">
          <div class="container">
            ...
            <div class="col-md-7 text-center heading-section ftco-animate">
              <span class="subheading"><?php echo e(trans('songage_title')); ?></span>
              <h2 class="mb-4"><?php echo e(trans('sondage_header')); ?></h2>
              <p><?php echo e(trans('sondage_content')); ?></p>
              <p><?php echo e(trans('sondage_content1')); ?></p>
            </div>
          </div>
...
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kirra belloche\Desktop\bloo\Bloo\resources\views/pages/sondages.blade.php ENDPATH**/ ?>