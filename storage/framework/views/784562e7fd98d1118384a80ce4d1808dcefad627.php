...
<head>
    ...
    <meta name="description" content="Laravel BLOO Admin ">
    <meta name="author" content="Infinite Solution">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">BLOO Admin </div>
        </a>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="<?php echo e(route('language')); ?>" id="alertsDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="fab fa-font-awesome-flag"></i>

                            <!-- Counter - Alerts -->
                            <span class="badge badge-info badge-counter">fr</span>
                        </a>
                        <!-- Dropdown - Alerts -->
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <figure class="img-profile rounded-circle avatar font-weight-bold" data-initial="<?php echo e(Auth::user()->name[1]); ?>"></figure>
                        </a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Infite Solutions 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<?php /**PATH C:\Users\kirra belloche\Desktop\bloo\Bloo\resources\views/layouts/admin.blade.php ENDPATH**/ ?>